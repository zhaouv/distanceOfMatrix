...
function backtrack!(t::Int, mod::Int, wlength::Int, x::Array{Int,1}, ce::Array{Array{Int,1},1}, result::Bool) 
    if result 
        return result
    end
    if t >= wlength 
        ...
        for i in [0,1]
            ...
            result = backtrack!(t + 1, mod, wlength, x, ce, result);
            if result 
                return result
            end
        end
...
function process(mod::Int) 
    ...
    while true
        ...
        result = backtrack!(0, mod, wlength, x, ce, result)
